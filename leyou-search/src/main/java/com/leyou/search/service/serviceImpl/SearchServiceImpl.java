...
public class SearchServiceImpl implements SearchService {
    ...
    public Goods buildGoods(Spu spu) throws IOException {
        ...
        //查询出所有的搜索规格参数
        List<SpecParam> params = this.specificationClient.queryParams(spu.getCid3());
        //查询spuDetail,获取规则参数值
        ...
        goods.setCid1(spu.getCid1());goods.setCid2(spu.getCid2());
        ...
        for (String segment : param.getSegments().split(",")){
            ...
            if (val >= begin && val < end){
                if (segs.length == 1){
                    ...
                    result = segs[1] + param.getUnit() + "以上";
                }else {
